...
Console.WriteLine("Введите количетсво с строк и d столбцов матрицы 2");
...
if (b!=c)
{Console.WriteLine("Число столбцов b матрицы 1 должно совпадать с числом строк с матрицы 2!");}
